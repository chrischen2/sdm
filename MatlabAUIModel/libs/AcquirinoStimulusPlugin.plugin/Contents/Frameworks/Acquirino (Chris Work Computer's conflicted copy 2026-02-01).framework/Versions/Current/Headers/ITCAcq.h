...
// spatial stimuli    FMR 6/09
struct ITCSpatialStmParameters
{
	long pts;
	char spare[12];
};
typedef struct ITCSpatialStmParameters ITCSpatialStmParameters;
...
long ITCSpatialParams(char SegmentNumber, ITCSpatialStmParameters *SpatialParams); 
