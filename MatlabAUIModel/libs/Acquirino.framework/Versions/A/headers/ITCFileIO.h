...
bool WriteStructure(FILE* file, const ITCSpatialStmParameters* data);
...
bool ReadStructure(FILE* file, ITCSpatialStmParameters* data);
...
bool Write_ITCSpatialStmParameters(FILE* file, const ITCSpatialStmParameters* data);
...
bool Read_ITCSpatialStmParameters(FILE* file, ITCSpatialStmParameters* data);
